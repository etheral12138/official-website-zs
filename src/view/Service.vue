    ...
    <div class="container">
      <div class="Service-container row">
        <div v-for="(item,index) in serviceList"
             :key="index" class="Service-item col-xs-12 col-sm-6 col-md-4 wow slideInUp" @click="ServiceClick(item.id)">
      ...
      serviceList: [
        {
          id: 'section-1',
          title: '智慧农业',
          eng_title: 'Smart Agriculture',
          img: require('@/assets/img/service1.jpg')
        }, {
          id: 'section-2',
          title: '智慧教育',
          eng_title: 'Smart Education',
          img: require('@/assets/img/service2.jpg')
        }, {
          id: 'section-3',
          title: '智慧医疗',
          eng_title: 'Smart Medical',
